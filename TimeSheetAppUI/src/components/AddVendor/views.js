...
import { addVendor, updateVendor } from "../../redux/actions/Vendor_list";
...
class VendorView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      VendorDetail: this.props.location.state.vend,
      data: {
        firstName: "",
        lastName: "",
        vendorID: "",
  ...
  onSubmit = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      this.props.dispatch(
        updateVendor({
          _id: this.state.VendorDetail._id,
          firstName: firstName,
          lastName: lastName,
          vendorID: vendorID,
  ...
  render() {
    ...
    console.log("Vendor detail", this.state.VendorDetail);
    let timeSheetMenu;
    let projectMenu;
                  ...
                  <Card>
                    ...
                    <Form.Item error={!!errors.primaryEmail}>
                      <Input
                        ...
                        type="email"
                        name="primaryEmail"
                        value={this.state.data.primaryEmail}
                        onChange={this.onChange}
                  ...
                  <Card>
                    ...
                    <Form.Item>
                      <Input
                        ...
                        type="email"
                        name="secondaryEmail"
                        value={this.state.data.secondaryEmail}
                        onChange={this.onChange}
                  ...
                  <Card>
                    ...
                    <Form.Item error={!!errors.approverName}>
                      <Input
                        ...
                        type="text"
                        name="approverName"
                        value={this.state.data.approverName}
                        onChange={this.onChange}
...
export default compose(withNamespaces(), connect(mapStateToProps))(VendorView);
